      ...
      <div className={css.sentiment_summary_text}>
        ...
        <ul>
          ...
          <li>
            ...
            single number from +100 (all positive) to -100 (all negative), with
            0 meaning there are equal amounts of positive and negative feedback.
          </li>
          <li>
            ...
            “Insights deep dive” segment.
          </li>
          <li>
            Among 1- and 2-star reviews NSS is below zero in almost all areas
            with some anomalies, like ambience being slightly positive (6) among
            2-star ratings in 2025 Q1.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            only has either positive or negative sentiment.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            Compared to all reviews, ambience as a topic goes down among 1- and
            2- star reviews. It is sometimes the least discussed topic among
            1-star reviews.
          </li>
          <li>
